...
public class DateUtil extends DateUtils {
     ...
     * @throws Exception
     */
    public static String getLastMonthFirstDate(String yearMonth) throws Exception {
     ...
     * @throws Exception
     */
    public static String getNextMonthLastDate(String yearMonth) throws Exception {
        Calendar calendar = Calendar.getInstance();
        Date date = parseDate(yearMonth + "-01");
        calendar.setTime(date);
     ...
     * @throws Exception
     */
    public static int getAge(Date birthDate,Date nowDate) throws Exception {
        ...
        nowCalendar.setTime(birthCalendar.getTime());

        int yearBirth = nowCalendar.get(Calendar.YEAR);
        int monthBirth = nowCalendar.get(Calendar.MONTH);
        int dayOfMonthBirth = nowCalendar.get(Calendar.DAY_OF_MONTH);
